...
$.widget("ui.multidraggable", $.extend({}, $.ui.draggable.prototype, {
	...
	_mouseStart: function(event) {
		...
		if (this.element.hasClass('ui-selected')) {
			...
			$(".ui-selected").each(function () { $(this).multidraggable("mouseStart", event, o); });
			return true;
		} else {
	...
	_mouseDrag: function(event, noPropagation) {
		if (this.element.hasClass('ui-selected')) {
			$(".ui-selected").each(function () { $(this).multidraggable("mouseDrag", event, noPropagation); });
			return false;
		} else {
	...
	_mouseStop: function(event) {
		if (this.element.hasClass('ui-selected')) {
			$(".ui-selected").each(function () { $(this).multidraggable("mouseStop", event); });
			return false;
		} else {
